...
import com.Raamsa.raamsa.OwnerUi.PlotDetails_Owner;
...
public class AdapterForPlots_Owner extends RecyclerView.Adapter<AdapterForPlots_Owner.ViewHolder> {
    Context context;
    List<Plots> Plots = new ArrayList<>();

    public AdapterForPlots_Owner(Context context, List<Plots> Plots) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        if (Plots.size() > 0) {
            ...
            if (Plots.get(i).getPlot_name() != null && !Plots.get(i).getPlot_name().equalsIgnoreCase("")) {
                viewHolder.tv_PlotName.setText(Plots.get(i).getPlot_name());
            } else {
            ...
            if (Plots.get(i).getFace_name() != null && !Plots.get(i).getFace_name().trim().equalsIgnoreCase("")) {
                viewHolder.tv_Faceing.setText(Plots.get(i).getFace_name());
            } else {
            ...
            viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(context, PlotDetails_Owner.class);
                    intent.putExtra("plotData", Plots.get(i));
