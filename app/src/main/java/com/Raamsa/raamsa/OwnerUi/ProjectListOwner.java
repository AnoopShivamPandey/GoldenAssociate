...
public class ProjectListOwner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_project_list_owner);
        findViewByIds();
        ...
        gridLayoutManager = new GridLayoutManager(ProjectListOwner.this, 1);
    ...
    private void forRunningProjects() {
        final ProgressDialog progressDialog = new ProgressDialog(ProjectListOwner.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Api_Urls.BASE_URL + url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jsonObject.getBoolean("status")) {
                        ...
                        if (data != null) {
                            ...
                            if (projectsList != null && projectsList.size() > 0) {
                                ...
                                if (page == 1) {
                                    ...
                                    adapterForRunningProjects = new AdapterForRunningProjectsOwner(ProjectListOwner.this, projectsListAdapter, fromWhere);
                        ...
                        Toast.makeText(ProjectListOwner.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                rv_projects.setVisibility(View.GONE);
                progressDialog.dismiss();
                Toast.makeText(ProjectListOwner.this, "Network Problem", Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ProjectListOwner.this);
