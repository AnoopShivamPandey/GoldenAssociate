...
import com.Raamsa.raamsa.UI.BlocksActivity;
...
public class Project_Details_Owner extends AppCompatActivity {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_project__details__owner);
        ...
        } else if (fromWhere != null && fromWhere.equalsIgnoreCase("rowhouse")) {
            ll_btn.setVisibility(View.VISIBLE);
        ...
        btn_avilplot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (fromWhere != null && fromWhere.equalsIgnoreCase("plot")) {
                    startActivity(new Intent(Project_Details_Owner.this, BlocksActivity.class).putExtra("from_where", "available").putExtra("project_id", project_id));
                } else if (fromWhere != null && fromWhere.equalsIgnoreCase("flat")) {
                    startActivity(new Intent(Project_Details_Owner.this, Flats_Owner.class).putExtra("from_where", "available").putExtra("project_id", project_id));
                } else if (fromWhere != null && fromWhere.equalsIgnoreCase("rowhouse")) {
                    startActivity(new Intent(Project_Details_Owner.this, RowHouses_Owner.class).putExtra("from_where", "available").putExtra("project_id", project_id));
                }
                else if (fromWhere != null && fromWhere.equalsIgnoreCase("row houses")) {
                    startActivity(new Intent(Project_Details_Owner.this, RowHouses_Owner.class).putExtra("from_where", "available").putExtra("project_id", project_id));
                }
        ...
        btn_bookplot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (fromWhere != null && fromWhere.equalsIgnoreCase("plot")) {
                    startActivity(new Intent(Project_Details_Owner.this, BlocksActivity.class).putExtra("from_where", "booked").putExtra("project_id", project_id));
                } else if (fromWhere != null && fromWhere.equalsIgnoreCase("flat")) {
                    startActivity(new Intent(Project_Details_Owner.this, Flats_Owner.class).putExtra("from_where", "booked").putExtra("project_id", project_id));
                } else if (fromWhere != null && fromWhere.equalsIgnoreCase("rowhouse")) {
                    startActivity(new Intent(Project_Details_Owner.this, RowHouses_Owner.class).putExtra("from_where", "booked").putExtra("project_id", project_id));
                }
                else if (fromWhere != null && fromWhere.equalsIgnoreCase("row houses")) {
                    startActivity(new Intent(Project_Details_Owner.this, RowHouses_Owner.class).putExtra("from_where", "booked").putExtra("project_id", project_id));
                }
    ...
    public void getDetails() {
        final ProgressDialog progressDialog = new ProgressDialog(Project_Details_Owner.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Api_Urls.BASE_URL + Url, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (jsonObject.getBoolean("status")) {
                        ...
                        if (jsonObject1.getString("image") != null && !jsonObject1.getString("image").equalsIgnoreCase("")) {
                            ...
                            Picasso.with(Project_Details_Owner.this).load(jsonObject1.getString("image")).fit().into(img_slider);
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                Toast.makeText(Project_Details_Owner.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Project_Details_Owner.this);
