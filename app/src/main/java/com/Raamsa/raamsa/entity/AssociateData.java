...
public class AssociateData implements Serializable {
    ...
    public static List<AssociateData> createListFromJson(String json) {
        Gson gson = new Gson();
        Type type = new TypeToken<List<AssociateData>>() {
        }.getType();
        return gson.fromJson(json, type);
    }

    public static String createJsonFromList(List<AssociateData> object) {
        Gson gson = new Gson();
        Type type = new TypeToken<AssociateData>() {
        }.getType();
        return gson.toJson(object, type);
    }

    public static AssociateData createobjectFromJson(String json) {
        Gson gson = new Gson();
        Type type = new TypeToken<AssociateData>() {
        }.getType();
        return gson.fromJson(json, type);
    ...
    public static String createjsonFromObject(AssociateData object) {
        Gson gson = new Gson();
        Type type = new TypeToken<AssociateData>() {
        }.getType();
        return gson.toJson(object, type);
